...
ABILITY_ATTRIBUTE_ALIASES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        "能力伤害上限",
        ("能力伤害上限", "能力傷害上限", "アビリティのダメージ上限", "アビリテイのダメージ上限"),
    ),
    (
        "奥义伤害上限",
        ("奥义伤害上限", "奥義傷害上限", "奥義のダメージ上限", "奥義の与ダメージ上限"),
    ),
    (
        "能力伤害",
        ("能力伤害", "能力傷害", "アビリティの与ダメージ", "アビリテイの与ダメージ"),
    ),
    ("奥义伤害", ("奥义伤害", "奥義傷害", "奥義の与ダメージ", "奥義のダメージ")),
    ("攻击力", ("攻击力", "攻擊力", "攻撃力")),
    ("暴击率", ("暴击率", "暴擊率", "クリティカル確率", "クリテイカル確率")),
    ("昏厥值", ("昏厥值", "昏厥値", "昏厥值", "スタン値", "スタソ値")),
    ("HP", ("HP", "ＨＰ")),
)
