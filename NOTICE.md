...
Chiaki is not included in this source tree or its build output. Obtain Chiaki
separately from its official release/source location and retain its notices if
you distribute it with another package.
